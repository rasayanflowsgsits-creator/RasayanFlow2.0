...
export default function StudentDashboard() {
  const { labs, transactions, storeAllotments, fetchLabs, fetchTransactions, fetchStoreAllotments, fetchInventorySearch, createBorrowRequest, setToast, fetchLabRequests, createLabRequest, labRequests } = useAppStore();
  ...
  useEffect(() => {
    ...
    fetchLabRequests();
  }, [fetchLabs, fetchStoreAllotments, fetchTransactions, fetchLabRequests]);
